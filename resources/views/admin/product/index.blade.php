      ...
      <div class="card">
        <div class="card-header">
          ...
          <ul class="nav nav-pills">
            <li class="nav-item"><a id="LList" class="nav-link active" href="#list" data-toggle="tab">รายกรสินค้า</a></li>
        ...
        <div class="tab-content">
                ...
                <tbody>
                    @foreach ($product as $item)
                        ...
                        <td style="width: 1px;hieght: 20px">
                          <div class="btn-group">
                            {{-- <div class="col-4 ">  --}}
                              <form action="{{ route('product.update',$item->id) }}" method="post" id="up{{ $item->id }}">
                                @csrf
                                @method('PUT')
                                <input type="hidden" name="updateQTY" id="update{{ $item->id}}" value="" />
                                 <button class="btn btn-success" type="button" onclick="add{{$item->id}}()" >เพิ่ม</button>
                              </form>
                            {{-- </div> --}}
                            {{-- <div class="col-4 ">  --}}
                            ...
                            {{-- <div class="col-4 "> --}}
                              ...
                              @csrf
                              @method('DELETE')
                                <button class="btn btn-danger" type="button"  onclick="del{{ $item->id }}()">ลบ</button>
                              </form>
          ...
          <div class="tab-pane" id="add">
            <form action="{{ route('product.store')}}" method="post" aria-multiline="true" enctype="multipart/form-data">
              @csrf
              ...
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control  @error('name') is-invalid @enderror" id="inputName3" placeholder="Name" name="name" required>
                    @error('name')
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" id="inputQty3" placeholder="Qty" name="qty" min="0" max="1000" required>
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputUnit3" class="col-sm-2 col-form-label">หน่วยนับ</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputUnit3" placeholder="ชิ้น/แผง/อัน/อื่นๆ" name="unit" required>
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputdes" class="col-sm-2 col-form-label">รายละเอียด</label>
                  <div class="col-sm-10">
                    <textarea class="form-control" id="inputdes" name="des" id="des"  rows="3" required></textarea>
