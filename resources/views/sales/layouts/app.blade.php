...
<body id="body" class=" layout-navbar-fixed sidebar-collapse sidebar-mini" style="font-family:  'Itim', cursive">
    <div class="wrapper">
        ...
        <!-- Navbar -->
        <nav class="main-header navbar navbar-expand navbar-white navbar-light  " style="background-color: #F0C929;">
            <!-- Left navbar links -->
            <ul class="navbar-nav">
                <li class="nav-item">
            ...
            <ul class="nav nav-treeview"> --}}
                        <li class="nav-item">
                            <a href="{{ route('sale.index') }}"
                                class="nav-link {{ request()->routeIs('sale.index') ? 'active' : '' }}">
                                <i class="nav-icon fas fa-cart-plus"></i>
                                <p>ขาย</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('sale2.index') }}"
                                class="nav-link {{ request()->routeIs('sale2.index') ? 'active' : '' }}">
                                <i class="nav-icon fas fa-shopping-cart"></i>
                                <p>ขายส่ง</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('transection.index') }}"
                                class="nav-link {{ request()->routeIs('transection.index') ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('return.index') }}"
                                class="nav-link {{ request()->routeIs('return.index') ? 'active' : '' }}">
